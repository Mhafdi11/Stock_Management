...
<head>
  ...
  <title>Stock Management ENSAKH</title>

  <link rel="icon" href="https://ensak.usms.ac.ma/preinscriptionENSAK/web/images/ensa.png">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome to Stock Management ENSAKH!</h1>
                  </div>
